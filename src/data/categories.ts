...
export const CATEGORIES: Category[] = [
  {
    ...
    houseLine: "Timeless garments built to outlive trends.",
  ...
  },
  {
    ...
    houseLine: "Precision, comfort and enduring craftsmanship.",
  ...
  },
  {
    ...
    houseLine: "Scents created to become signatures rather than trends.",
